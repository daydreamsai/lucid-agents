...
public model and render the same read-only table. The built-in presets use
Lucid's Ink/Paper/Citron foundation and a compact footer attribution while
keeping the agent's name and offering primary.
