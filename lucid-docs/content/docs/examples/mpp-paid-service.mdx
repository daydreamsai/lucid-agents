...
For the complete current method surface—including native Tempo, Stripe, and EVM
charges, custom and Lightning verifier boundaries, durable task admission, and
Tempo TIP-1034 sessions—start with
[Every MPP payment method](/docs/examples/mpp-payment-methods). This page remains
the smaller one-method server walkthrough.
