...
Choose a model whose authorization ceiling, settlement point, and fulfilled
usage can be reconciled before Lucid commits the HTTP operation. Fixed charges
are the simplest model; x402 upto and Tempo sessions add bounded metering with
different operation support.
...
Continue with [every x402 payment method](/docs/examples/x402-payment-methods),
